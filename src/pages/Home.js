...
//       <header
//         className={`py-5 d-flex flex-column justify-content-center align-items-center container-fluid ${style.header} `}
//         // style={{
//         //   height: "100vh",
...
//           </Link>
//         </span>
//         <div className="row gap-3 bg-dark">
//           <div className="col-3-md bg-white" style={{height:'10px'}}></div>
      ...
      <div className="ck-root">
        ...
        <header className="ck-hero">
          ...
          <div className="ck-hero-content">
            ...
            <h1 className="ck-hero-title">CoderKing</h1>
        ...
        <div className="ck-courses-wrap" style={{paddingTop: "80px"}}>
          <div className="ck-courses-head">
            ...
            <Link to="/courses/free" className="ck-btn-outline" style={{fontSize: "13px", padding: "9px 18px"}}>
              View All
            </Link>
          </div>
        ...
        <div className="ck-courses-wrap" style={{paddingTop: "0"}}>
          <div className="ck-courses-head">
            ...
            <Link to="/courses/trending" className="ck-btn-outline" style={{fontSize: "13px", padding: "9px 18px"}}>
              View All
            </Link>
          </div>
          <div className="ck-course-grid">
